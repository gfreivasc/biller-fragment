...
class BindingCounterIntegrationTest {
    ...
    class BindingFactory : FragmentFactory() {
        override fun instantiate(
            classLoader: ClassLoader,
            className: String
        ): Fragment {
            return DefaultCounterController { BindingCounterView(it) }
        }
    }

    private val setup = CounterSetup(BindingFactory())
