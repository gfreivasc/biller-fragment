...
import com.gabrielfv.core.arch.tests.WrongInitializationOverrideController
...
class WrongInitializationOverrideControllerTest {
    private val view = mockk<View<CounterState>>(relaxed = true)

    @Test
    fun breaksOnInitWithIllegalState() {
        val subject = WrongInitializationOverrideController { view }
        ...
        MatcherAssert.assertThat(
            ...
            CoreMatchers.`is`(
                """
                    [WrongInitializationOverrideController.onInitialize()] does not
